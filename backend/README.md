...
## Project Structure
    ...
    ├── tst_dsafwfwvfeav_de_65874  # Django project configurations
...
1. Clone this repo and `cd tst_dsafwfwvfeav_de_65874`
...
2. Clone this repo and `cd tst_dsafwfwvfeav_de_65874`
